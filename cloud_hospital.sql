...
CREATE TABLE `checkreport`  (
  ...
  `diagnostictype` int(11) NOT NULL COMMENT '诊断类型 1.初诊 2.复诊',
  ...
  `me_id` int(11) NULL DEFAULT NULL COMMENT '电子病历ID',
  `seektime` datetime NULL DEFAULT NULL COMMENT '检查时间',
  `de_id` int(11) NULL DEFAULT NULL COMMENT '就诊科室',
  ...
  `bgys_id` int(11) NULL DEFAULT NULL COMMENT '报告医生',
  `shys_id` int(11) NULL DEFAULT NULL COMMENT '审核医生',
...
CREATE TABLE `consultation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '健康咨询信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `consultation` VALUES (3, 'lisi', '0', '拉肚子', '肠炎宁', '11', '22', 33, '2020-05-22 14:29:43', '2020-05-22 14:29:45', 0);
INSERT INTO `consultation` VALUES (4, '尔康', '1', '腿抽筋', '拉伸', '1', '22', 34, '2020-05-22 14:30:31', '2020-05-22 14:30:35', 1);
...
CREATE TABLE `empinfo`  (
  ...
  `dep_id` int(11) NULL DEFAULT NULL COMMENT '科室ID',
...
INSERT INTO `empinfo` VALUES (34, '王医生', '111111', '2020-04-01 15:35:20', '13734741053', '河南-郑州-金水', 1, 34, 33, '医生界的扛把子，抗击新冠肺炎一马当先', NULL, '10', 1, NULL, NULL);
...
CREATE TABLE `medicalrecord`  (
  ...
  `seektime` datetime NULL DEFAULT NULL COMMENT '就诊日期',
